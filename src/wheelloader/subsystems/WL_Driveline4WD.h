...
#ifndef WL_DRIVELINE_4WD_H
#define WL_DRIVELINE_4WD_H
...
/// Shafts-based 4-WD driveline for the WL vehicle.
class  WL_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    WL_Driveline4WD(const std::string& name);
    ~WL_Driveline4WD() {}
